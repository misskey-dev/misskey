...
import { wallMountSpotLight_schema } from 'misskey-world/src/room/furnitures/wallMountSpotLight.schema.js';

export const wallMountSpotLight = defineFurniture(wallMountSpotLight_schema, {
