	...
	<FormSection>
		...
		<div class="_gaps_m">
			<div class="_gaps_s">
				...
				<MkSwitch v-model="checkRedirectingOtherHost">{{ i18n.ts.checkRedirectingOtherHost }}</MkSwitch>
...
const checkRedirectingOtherHost = computed(defaultStore.makeGetterSetter('checkRedirectingOtherHost'));
