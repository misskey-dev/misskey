	...
	<FormSection>
		...
		<div class="_gaps_m">
			<div class="_gaps_s">
				...
				<MkSwitch v-model="showPreviewByDefault">{{ i18n.ts.showPreviewByDefault }}</MkSwitch>
			</div>
			<div>
...
const showPreviewByDefault = computed(defaultStore.makeGetterSetter('showPreviewByDefault'));
