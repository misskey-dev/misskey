...
<div>
	<div v-if="!loading" class="_gaps">
		<MkInfo>{{ i18n.tsx._profile.avatarDecorationMax($i.policies.avatarDecorationLimit) }} ({{ i18n.tsx.remainingN($i.policies.avatarDecorationLimit - $i.avatarDecorations.length) }})</MkInfo>
