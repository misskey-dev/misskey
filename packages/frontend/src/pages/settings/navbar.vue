				...
				>
					<template #default="{ item, dragStart, touchStart }">
						<div
							...
							:class="$style.item"
						>
							<button class="_button" :class="$style.itemHandle" tabindex="-1" :draggable="true" @dragstart.stop="dragStart" @touchstart.passive="touchStart"><i class="ti ti-menu"></i></button>
