	...
	<MkFolder>
		...
		<div class="_gaps_m">
			...
			<MkDraggable
				...
				manualDragStart
			>
				<template #default="{ item, index, dragStart, touchStart }">
					<div :class="$style.item">
						<div :class="$style.itemHeader">
							<div :class="$style.itemNumber">{{ index + 1 }}</div>
							<span :class="$style.itemHandle" :draggable="true" @dragstart.stop="dragStart" @touchstart.passive="touchStart"><i class="ti ti-menu"></i></span>
