...
api('admin/announcements/list').then(announcementResponse => {
...
function del(announcement) {
	os.confirm({
		...
		api('admin/announcements/delete', announcement);
	});
}
...
function more() {
	api('admin/announcements/list', { untilId: announcements.value.reduce((acc, announcement) => announcement.id != null ? announcement : acc).id }).then(announcementResponse => {
