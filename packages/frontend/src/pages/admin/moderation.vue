	...
	<div class="_spacer" style="--MI_SPACER-w: 700px; --MI_SPACER-min: 16px; --MI_SPACER-max: 32px;">
		<SearchMarker path="/admin/moderation" :label="i18n.ts.moderation" :keywords="['moderation']" icon="ti ti-shield" :inlining="['serverRules']">
			<div class="_gaps_m">
				...
				<SearchMarker :keywords="['initial', 'tutorial']">
					<MkSwitch v-model="prohibitSkippingInitialTutorial" type="checkbox" @change="onChange_prohibitSkippingInitialTutorial">
						<template #label><SearchLabel>{{ i18n.ts.prohibitSkippingInitialTutorial }}</SearchLabel></template>
...
const prohibitSkippingInitialTutorial = ref(!meta.canSkipInitialTutorial);
