...
<MkStickyContainer>
	...
	<MkSpacer :contentMax="900">
		<div>
			<div style="display: flex; gap: var(--MI_UI-margin); flex-wrap: wrap;">
			...
			<MkPagination v-slot="{items}" ref="logs" :pagination="pagination" style="margin-top: var(--MI_UI-margin);">
				<MkDateSeparatedList v-slot="{ item }" :items="items" :noGap="false" style="--MI_UI-margin: 8px;">
