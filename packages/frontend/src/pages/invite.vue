...
<MkStickyContainer>
	...
	<MkSpacer v-else :contentMax="800">
		<div class="_gaps_m" style="text-align: center;">
			<div v-if="resetCycle && inviteLimit">{{ i18n.tsx.inviteLimitResetCycle(resetCycle, inviteLimit) }}</div>
			...
			<div v-if="currentInviteLimit !== null">{{ i18n.tsx.createLimitRemaining(currentInviteLimit) }}</div>
