...
<div :class="$style.root">
	...
	<button v-if="(!isDesktop || pageMetadata?.needWideArea) && !isMobile && pageMetadata?.hideWidgetFab !== true" :class="$style.widgetButton" class="_button" @click="widgetsShowing = true"><i class="ti ti-apps"></i></button>
