...
export const searchIndexes: SearchIndexItem[] = [
		...
		children: [
			{
				...
				keywords: ['search', 'engine', 'searx', 'yami', i18n.ts._yami.searchEngineDescription],
			},
		],
		label: i18n.ts._yami.yamiSet,
		keywords: ['yami', 'original', 'custom'],
		path: '/settings/yamiset',
		icon: 'ti ti-key',
	},
	{
		id: 'flXd1LC7r',
	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				keywords: ['follow', 'auto', 'reject', 'request', i18n.ts.autoRejectFollowRequestDescription],
			},
			{
				id: '5hAiPsvL6',
			...
			},
			{
				...
				keywords: ['activity', 'hide', 'visibility', i18n.ts.hideActivityDescription],
			},
			{
				id: '3HiV7Q9u9',
				label: i18n.ts.hideProfileFiles,
				keywords: ['profile', 'files', 'hide', 'visibility', i18n.ts.hideProfileFilesDescription],
			},
			{
				id: 'izbVlS3rh',
			...
			{
				id: 'tuxwL6QYm',
				label: i18n.ts.notesVisibility,
				keywords: ['notes', 'visibility'],
			},
			{
				id: 'xryqY95La',
				children: [
		...
		label: i18n.ts.hideSearchResult,
		keywords: ['privacy', i18n.ts.hideSearchResultDescription],
		...
		children: [
			...
			},
			{
				...
				children: [
					{
						id: 'EO5WHBeG8',
						label: i18n.ts.collapseSelfRenotes,
						keywords: ['renote', i18n.ts.collapseSelfRenotesDescription],
					},
					{
						id: '1yhown1Xc',
	...
	},
	{
		...
		children: [
			{
				id: 'hPPEzjvZC',
				label: i18n.ts.importOrigin,
				keywords: ['notes', i18n.ts.importNoteInfo],
			},
			{
				id: '7POaqfDxN',
	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				keywords: ['font', 'system', 'native', 'custom'],
			},
			{
				id: '7AOZ1ZgDv',
			...
			},
			{
				...
				children: [
					...
					},
					{
						...
						keywords: ['reaction', 'hide', 'count', 'user', 'mute', 'check', i18n.ts.hideReactionUsersDescription, i18n.ts._reactionChecksMuting.caption],
					},
				],
