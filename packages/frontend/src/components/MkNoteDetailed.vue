    ...
    <article class="article" @contextmenu.stop="onContextmenu">
      ...
      <div class="main">
        ...
        <footer class="footer">
          ...
          <button v-if="canRenote" ref="renoteButton" class="button _button" @mousedown="renote()">
            <i class="ti ti-repeat"></i>
...
const isRenote = note.renote != null && note.text == null && note.fileIds.length === 0 && note.poll == null;
