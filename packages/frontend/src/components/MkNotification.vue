...
<div :class="$style.root">
	...
	<div :class="$style.tail">
		<header :class="$style.header">
			...
			<span v-else-if="notification.type === 'reaction:grouped'">{{ i18n.tsx._notification.reactedBySomeUsers(notification.reactions.length) }}</span>
			<span v-else-if="notification.type === 'renote:grouped'">{{ i18n.tsx._notification.renotedBySomeUsers(notification.users.length) }}</span>
