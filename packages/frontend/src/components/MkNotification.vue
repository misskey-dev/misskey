  ...
  <div ref="elRef" :class="$style.root">
    <div :class="$style.head">
      ...
      <div :class="[$style.subIcon, $style['t_' + notification.type]]">
        ...
        <MkReactionIcon
          ...
          ref="reactionRef"
          :reaction="
            notification.reaction ? notification.reaction.replace(/^:(\w+):$/, ':$1@.:') : notification.reaction
          "
    ...
    <div :class="$style.tail">
      ...
      <div :class="$style.content">
        ...
        <span v-else-if="notification.type === 'followRequestAccepted'" :class="$style.text" style="opacity: 0.6">{{
        ...
        <template v-else-if="notification.type === 'groupInvited'">
          <span :class="$style.text" style="opacity: 0.6"
            >{{ i18n.ts.groupInvited }}: <b>{{ notification.invitation.group.name }}</b></span
          >
