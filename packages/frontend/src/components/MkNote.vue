...
<div
	...
	ref="rootEl"
	v-hotkey="keymap"
	:class="[$style.root, { [$style.showActionsOnlyHover]: preferences.s.showNoteActionsOnlyHover, [$style.skipRender]: preferences.s.skipNoteRender }]"
		...
		<div :class="$style.main">
			...
			<footer :class="$style.footer">
				...
				<button ref="reactButton" :class="$style.footerButton" class="_button" @click="toggleReact()">
					...
					<p v-if="(appearNote.reactionAcceptance === 'likeOnly' || preferences.s.showReactionsCount) && appearNote.reactionCount > 0" :class="$style.footerButtonCount">{{ number(appearNote.reactionCount) }}</p>
				</button>
				<button v-if="preferences.s.showClipButtonInNoteFooter" ref="clipButton" :class="$style.footerButton" class="_button" @mousedown.prevent="clip()">
...
const showSoftWordMutedWord = computed(() => preferences.s.showSoftWordMutedWord);
...
const renoteCollapsed = ref(
	preferences.s.collapseRenotes && isRenote && (
