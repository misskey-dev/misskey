...
>
	...
	<div v-if="isRenote" :class="$style.renote">
		...
		<div :class="$style.renoteInfo">
			...
			<span v-if="note.visibility === 'public' && note.channel == null && note.isNoteInYamiMode === true" style="margin-left: 0.5em;" :title="`${i18n.ts._visibility[note.visibility]} (${i18n.ts._hana.yamiMode})`"><i class="ti ti-moon"></i></span>
