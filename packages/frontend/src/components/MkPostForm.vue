...
>
	...
	<MkInfo v-if="!store.r.tips.value.postForm" :class="$style.showHowToUse">
		<button class="_textButton" @click="showTour">{{ i18n.ts._postForm.showHowToUse }}</button> / <button class="_textButton" @click="closeTip('postForm')">{{ i18n.ts.skip }}</button>
	</MkInfo>
