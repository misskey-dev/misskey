				...
				<div :class="$style.centerPage">
					<MkSpacer :marginMin="20" :marginMax="28">
						<div class="_gaps" style="text-align: center;">
							...
							<div style="padding: 0 16px;">{{ i18n.tsx._initialAccountSetting.pushNotificationDescription(instance.name ?? host) }}</div>
				...
				<div :class="$style.centerPage">
					...
					<MkSpacer :marginMin="20" :marginMax="28">
						<div class="_gaps" style="text-align: center;">
							...
							<div>{{ i18n.tsx._initialAccountSetting.youCanContinueTutorial(instance.name ?? host) }}</div>
							<div class="_buttonsCenter" style="margin-top: 16px;">
