...
<template>
<MkModal ref="modal" v-slot="{ type, maxHeight }" :manualShowing="manualShowing" :zPriority="'high'" :src="src" :transparentBg="true" :returnFocusElement="returnFocusElement" @click="click" @close="onModalClose" @closed="onModalClosed">
