...
<template>
<Transition
	:enterActiveClass="preferences.s.animation ? $style.transition_popup_enterActive : ''"
	:leaveActiveClass="preferences.s.animation ? $style.transition_popup_leaveActive : ''"
	:enterFromClass="preferences.s.animation ? $style.transition_popup_enterFrom : ''"
	:leaveToClass="preferences.s.animation ? $style.transition_popup_leaveTo : ''"
	appear @afterLeave="emit('closed')"
>
	<div v-if="showing" :class="$style.root" class="_popup _shadow" :style="{ zIndex, top: top + 'px', left: left + 'px' }" @mouseover="() => { emit('mouseover'); }" @mouseleave="() => { emit('mouseleave'); }">
		<div v-if="user != null">
			<div :class="$style.banner" :style="user.bannerUrl ? `background-image: url(${preferences.s.disableShowingAnimatedImages ? getStaticImageUrl(user.bannerUrl) : user.bannerUrl})` : ''">
