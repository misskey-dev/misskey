...
// defaultStoreをpreferに変更 - リアクションカウント表示設定
...
// defaultStoreをpreferに変更 - ミュートをチェックするかどうか
const reactionChecksMuting = computed({
	get: () => prefer.s.reactionChecksMuting,
	set: (value) => prefer.commit('reactionChecksMuting', value),
});
