...
// @public (undocumented)
export const notificationTypes: readonly ["note", "follow", "mention", "reply", "renote", "reaction", "pollVote", "pollEnded", "receiveFollowRequest", "followRequestAccepted", "groupInvited", "app", "roleAssigned", "achievementEarned"];
