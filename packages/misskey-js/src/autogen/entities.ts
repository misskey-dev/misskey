...
export type NotesSpReactionsRequest = operations['notes___sp-reactions']['requestBody']['content']['application/json'];
export type NotesSpReactionsResponse = operations['notes___sp-reactions']['responses']['200']['content']['application/json'];
export type NotesSpReactionsCreateRequest = operations['notes___sp-reactions___create']['requestBody']['content']['application/json'];
