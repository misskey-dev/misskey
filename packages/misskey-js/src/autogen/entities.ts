...
export type AntennasFavoriteRequest = operations['antennas___favorite']['requestBody']['content']['application/json'];
export type AntennasListResponse = operations['antennas___list']['responses']['200']['content']['application/json'];
export type AntennasMyFavoritesResponse = operations['antennas___my-favorites']['responses']['200']['content']['application/json'];
...
export type AntennasUnfavoriteRequest = operations['antennas___unfavorite']['requestBody']['content']['application/json'];
...
export type UsersAntennasRequest = operations['users___antennas']['requestBody']['content']['application/json'];
export type UsersAntennasResponse = operations['users___antennas']['responses']['200']['content']['application/json'];
