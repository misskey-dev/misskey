...
export type AdminOauthClientCreateServerRequest = operations['admin/oauth-client/create-server']['requestBody']['content']['application/json'];
export type AdminOauthClientUpdateServerRequest = operations['admin/oauth-client/update-server']['requestBody']['content']['application/json'];
...
export type OauthClientListResponse = operations['oauth-client/list']['responses']['200']['content']['application/json'];
export type OauthClientAuthorizeRequest = operations['oauth-client/authorize']['requestBody']['content']['application/json'];
export type OauthClientAuthorizeResponse = operations['oauth-client/authorize']['responses']['200']['content']['application/json'];
export type OauthClientCallbackRequest = operations['oauth-client/callback']['requestBody']['content']['application/json'];
export type OauthClientCallbackResponse = operations['oauth-client/callback']['responses']['200']['content']['application/json'];
