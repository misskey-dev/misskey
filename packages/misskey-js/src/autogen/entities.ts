...
export type AdminNotesRenoteLockCreateRequest = operations['admin___notes___renote-lock___create']['requestBody']['content']['application/json'];
export type AdminNotesRenoteLockDeleteRequest = operations['admin___notes___renote-lock___delete']['requestBody']['content']['application/json'];
...
export type NotesRenoteLockCreateRequest = operations['notes___renote-lock___create']['requestBody']['content']['application/json'];
export type NotesRenoteLockDeleteRequest = operations['notes___renote-lock___delete']['requestBody']['content']['application/json'];
