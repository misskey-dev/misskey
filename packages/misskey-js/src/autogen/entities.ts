...
export type V2FlashFeaturedRequest = operations['v2___flash___featured']['requestBody']['content']['application/json'];
export type V2FlashFeaturedResponse = operations['v2___flash___featured']['responses']['200']['content']['application/json'];
