...
export type AdminEmojiAddRequestRequest = operations['admin___emoji___add-request']['requestBody']['content']['application/json'];
...
export type AdminEmojiSetLocalonlyBulkRequest = operations['admin___emoji___set-localonly-bulk']['requestBody']['content']['application/json'];
export type AdminEmojiSetIssensitiveBulkRequest = operations['admin___emoji___set-issensitive-bulk']['requestBody']['content']['application/json'];
...
export type EmojiSpeedtestRequest = operations['emoji___speedtest']['requestBody']['content']['application/json'];
...
export type IStatsRequest = operations['i___stats']['requestBody']['content']['application/json'];
export type IStatsResponse = operations['i___stats']['responses']['200']['content']['application/json'];
