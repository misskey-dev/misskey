...
export type WorldRoomsListByUserRequest = operations['world___rooms___list-by-user']['requestBody']['content']['application/json'];
export type WorldRoomsListByUserResponse = operations['world___rooms___list-by-user']['responses']['200']['content']['application/json'];
export type WorldRoomsShowRequest = operations['world___rooms___show']['requestBody']['content']['application/json'];
export type WorldRoomsShowResponse = operations['world___rooms___show']['responses']['200']['content']['application/json'];
export type WorldRoomsUpdateRequest = operations['world___rooms___update']['requestBody']['content']['application/json'];
export type WorldRoomsUpdateResponse = operations['world___rooms___update']['responses']['200']['content']['application/json'];
