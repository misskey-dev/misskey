...
export type AdminSearchReindexRequest = operations['admin___search___reindex']['requestBody']['content']['application/json'];
export type AdminSearchReindexResponse = operations['admin___search___reindex']['responses']['200']['content']['application/json'];
