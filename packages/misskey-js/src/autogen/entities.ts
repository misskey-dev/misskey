...
export type IEmojiMuteListResponse = operations['i___emoji-mute___list']['responses']['200']['content']['application/json'];
export type IEmojiMuteUpdateRequest = operations['i___emoji-mute___update']['requestBody']['content']['application/json'];
export type IEmojiMuteUpdateResponse = operations['i___emoji-mute___update']['responses']['200']['content']['application/json'];
