...
export type AdminQueuePauseQueueRequest = operations['admin___queue___pause-queue']['requestBody']['content']['application/json'];
...
export type AdminQueueResumeQueueRequest = operations['admin___queue___resume-queue']['requestBody']['content']['application/json'];
