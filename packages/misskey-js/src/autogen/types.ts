...
export type paths = {
  ...
  '/i/bsk-migrate/get-miauth-id': {
     ...
     * **Credential required**: *Yes*
     */
    post: operations['i___bsk-migrate___get-miauth-id'];
  };
  '/i/bsk-migrate/remove': {
    /**
     * i/bsk-migrate/remove
     * @description No description provided.
     *
     ...
     * **Credential required**: *Yes*
     */
    post: operations['i___bsk-migrate___remove'];
  };
  '/i/bsk-migrate/status': {
    /**
     * i/bsk-migrate/status
     * @description No description provided.
     *
     ...
     * **Credential required**: *Yes*
     */
    post: operations['i___bsk-migrate___status'];
  };
  '/i/bsk-migrate/verify': {
    /**
     * i/bsk-migrate/verify
     * @description No description provided.
     *
     ...
     * **Credential required**: *Yes*
     */
    post: operations['i___bsk-migrate___verify'];
  };
  '/i/claim-achievement': {
    /**
     * i/claim-achievement
...
export type components = {
  schemas: {
    ...
    Notification: {
      ...
      /** @enum {string} */
      achievement: 'notes1' | 'notes10' | 'notes100' | 'notes500' | 'notes1000' | 'notes5000' | 'notes10000' | 'notes20000' | 'notes30000' | 'notes40000' | 'notes50000' | 'notes60000' | 'notes70000' | 'notes80000' | 'notes90000' | 'notes100000' | 'login3' | 'login7' | 'login15' | 'login30' | 'login60' | 'login100' | 'login200' | 'login300' | 'login400' | 'login500' | 'login600' | 'login700' | 'login800' | 'login900' | 'login1000' | 'passedSinceAccountCreated1' | 'passedSinceAccountCreated2' | 'passedSinceAccountCreated3' | 'loggedInOnBirthday' | 'loggedInOnNewYearsDay' | 'noteClipped1' | 'noteFavorited1' | 'myNoteFavorited1' | 'profileFilled' | 'markedAsCat' | 'markedAsHanaModeUser' | 'following1' | 'following10' | 'following50' | 'following100' | 'following300' | 'followers1' | 'followers10' | 'followers50' | 'followers100' | 'followers300' | 'followers500' | 'followers1000' | 'collectAchievements30' | 'viewAchievements3min' | 'iLoveMisskey' | 'iLoveHanaMisskey' | 'foundTreasure' | 'foundLegacy' | 'client30min' | 'client60min' | 'noteDeletedWithin1min' | 'postedAtLateNight' | 'postedAt0min0sec' | 'selfQuote' | 'htl20npm' | 'viewInstanceChart' | 'outputHelloWorldOnScratchpad' | 'open3windows' | 'driveFolderCircularReference' | 'reactWithoutRead' | 'clickedClickHere' | 'justPlainLucky' | 'setNameToSyuilo' | 'cookieClicked' | 'brainDiver' | 'smashTestNotificationButton' | 'tutorialCompleted' | 'bubbleGameExplodingHead' | 'bubbleGameDoubleExplodingHead';
    }) | ({
      /** Format: id */
      id: string;
      /** Format: date-time */
...
export type operations = {
   ...
   * **Credential required**: *Yes*
   */
  'i___bsk-migrate___get-miauth-id': {
    responses: {
      /** @description OK (with results) */
      200: {
        content: {
