...
import * as ep___notes_yamiTimeline from './endpoints/notes/yami-timeline.js';
...
const $notes_yamiTimeline: Provider = { provide: 'ep:notes/yami-timeline', useClass: ep___notes_yamiTimeline.default };
