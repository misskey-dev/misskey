...
const $emojiMutesRepository: Provider = {
	provide: DI.emojiMutesRepository,
	useFactory: (db: DataSource) => db.getRepository(MiEmojiMute).extend(miRepository as MiRepository<MiEmojiMute>),
	inject: [DI.db],
};
