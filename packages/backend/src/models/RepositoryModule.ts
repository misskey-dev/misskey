...
const $emojiModerationLogsRepository: Provider = {
	provide: DI.emojiModerationLogsRepository,
	useFactory: (db: DataSource) => db.getRepository(EmojiModerationLog),
	inject: [DI.db],
};
