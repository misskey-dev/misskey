...
export * as 'i/2fa/passkey/done' from './endpoints/i/2fa/passkey/done.js';
export * as 'i/2fa/passkey/password-less' from './endpoints/i/2fa/passkey/password-less.js';
export * as 'i/2fa/passkey/register' from './endpoints/i/2fa/passkey/register.js';
export * as 'i/2fa/passkey/remove' from './endpoints/i/2fa/passkey/remove.js';
export * as 'i/2fa/passkey/update' from './endpoints/i/2fa/passkey/update.js';
export * as 'i/2fa/totp/done' from './endpoints/i/2fa/totp/done.js';
export * as 'i/2fa/totp/register' from './endpoints/i/2fa/totp/register.js';
export * as 'i/2fa/totp/remove' from './endpoints/i/2fa/totp/remove.js';
