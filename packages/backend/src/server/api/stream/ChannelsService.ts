...
import { NoctownChannelService } from './channels/noctown.js';
...
export class ChannelsService {
	constructor(
		...
		private noctownChannelService: NoctownChannelService,
	) {
	}
	...
	public getChannelService(name: string): MiChannelService<boolean> {
		switch (name) {
			...
			case 'noctown': return this.noctownChannelService;
