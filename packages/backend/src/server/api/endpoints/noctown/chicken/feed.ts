...
export const meta = {
	...
	errors: {
		noPlayer: {
			...
			code: 'NO_PLAYER',
			id: 'a5c01f91-0008-4000-a000-000000000001',
		},
		chickenNotFound: {
			message: 'Chicken not found',
			code: 'CHICKEN_NOT_FOUND',
			id: 'a5c01f91-0008-4000-a000-000000000002',
		},
		feedNotFound: {
			message: 'Feed item not found',
			code: 'FEED_NOT_FOUND',
			id: 'a5c01f91-0008-4000-a000-000000000003',
		},
	},
} as const;
...
export default class extends Endpoint<typeof meta, typeof paramDef> {
	constructor(
		...
		super(meta, paramDef, async (ps, me) => {
			...
			const result = await this.noctownService.feedChicken(
				player.id,
				ps.chickenId,
				ps.feedItemId,
			);
