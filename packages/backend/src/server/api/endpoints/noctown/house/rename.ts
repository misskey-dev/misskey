...
export const meta = {
	...
	errors: {
		playerNotFound: {
			...
			id: 'a1b2c3d4-house-0004-0001-000000000001',
		},
		houseNotFound: {
			message: 'House not found.',
			code: 'HOUSE_NOT_FOUND',
			id: 'a1b2c3d4-house-0004-0001-000000000002',
		},
	},
} as const;
...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(
		...
		super(meta, paramDef, async (ps, me) => {
			...
			const result = await this.noctownService.updateHouseName(
				player.id,
				ps.houseId,
				ps.name,
			);
