...
const EndpointsServices: readonly (readonly [symbol, Ctor<object>])[] = [
	...
	[Symbol.for('ep:admin/roles/users'), ep___admin_roles_users.default],
	...
	[Symbol.for('ep:roles/list'), ep___roles_list.default],
	[Symbol.for('ep:roles/show'), ep___roles_show.default],
	[Symbol.for('ep:roles/users'), ep___roles_users.default],
