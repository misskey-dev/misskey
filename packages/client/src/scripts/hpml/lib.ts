...
export const funcDefs: Record<string, { in: any[]; out: any; category: string; icon: any; }> = {
	...
	strLen:          { in: ['string'],                     out: 'number',      category: 'text',       icon: 'ph-quotesright', },
	strPick:         { in: ['string', 'number'],           out: 'string',      category: 'text',       icon: 'ph-quotesright', },
	strReplace:      { in: ['string', 'string', 'string'], out: 'string',      category: 'text',       icon: 'ph-quotesright', },
	strReverse:      { in: ['string'],                     out: 'string',      category: 'text',       icon: 'ph-quotesright', },
	join:            { in: ['stringArray', 'string'],      out: 'string',      category: 'text',       icon: 'ph-quotesright', },
