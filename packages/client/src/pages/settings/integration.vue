...
const enableTwitterIntegration = instance.enableTwitterIntegration;
const enableDiscordIntegration = instance.enableDiscordIntegration;
const enableGithubIntegration = instance.enableGithubIntegration;
