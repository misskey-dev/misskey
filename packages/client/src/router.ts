...
const defaultRoutes = [
	...
	{ path: '/admin/:page(.*)?', component: $i?.isAdmin ? page('admin/index') : page('not-found'), props: route => ({ initialPage: route.params.page || null }) },
	{ path: '/admin', component: $i?.isAdmin ? page('admin/index') : page('not-found') },
