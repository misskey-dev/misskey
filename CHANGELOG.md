...
- Enhance: テキストエリア（複数行入力）で、高さを自動で調整するように（設定 > 環境設定 > アクセシビリティ で無効化できます）  
  (Cherry-picked from https://github.com/shrimpia/misskey/commit/ed93bc441019587177c79f182033b092de72d02e)
