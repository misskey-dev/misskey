...
- Node.js v24, v26 をサポートし、Node.js v22 のサポートを終了しました。 **すべての環境でNode.jsのバージョンアップが必要です。** 基本的には Node.js v26 を利用してください。
...
- Enhance: Node.js 24.17.0以降、26.4.0以降をサポートするようになり、Node.js 22.x のサポートを終了
