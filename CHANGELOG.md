...
- Node.js v24, v26 をサポートしました（24.17.0以降・26.4.0以降をサポート。v26を推奨します）。Node.js v22 （22.23.0以降）でも動作しますが、Node.js 側でのサポートが終了次第 Misskey でもサポートを終了する予定です。
...
- Enhance: Node.js 24.17.0以降、26.4.0以降をサポートするように
