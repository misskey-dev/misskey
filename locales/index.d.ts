...
export interface ParameterizedString<TUnion extends string = string, TTuple extends readonly (string | number)[] = readonly (string | number)[]> {
    [kParameters]: TUnion | TTuple;
}
