...
Misskey — проект распределённой площадки для микроблогов с открытым исходным кодом. Начало положил программист с ником syuilo из Японии в 2014 году. Misskey выделяется обилием разнообразных функций, как например «Диск» или «Реакции», и невероятно гибко настраиваемым интерфейсом пользователя.
