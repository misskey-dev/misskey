...
### المتابِعون
自分のフォロワーに対してのみノートを公開します。ستظهر الملاحظة في كل الخطوط الزمنية لمتابِعيك.

### مباشرة
ستظهر الملاحظة لمستخدمين محددين فقط.ستظهر الملاحظة في كل الخطوط الزمنية للمستخدمين المحددين.
...
### 公開範囲の比較
<table>
    <tr><th></th><th>علني</th><th>الرئيسي</th><th>المتابِعون</th><th>مباشرة</th></tr>
