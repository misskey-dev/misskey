# قرص التخرين
يستخدم لإدارة الملفات المرفوعة.

بالإضافة للملفات المرفوعة من [صفحة قرص التخزين](/my/drive) ، صورك الرمزية والصور المضمنة في الملاحظات ستُضاف لقرص التخزين.

<div class="warn">بحذفك لصورة ستُحذف كل الملاحظات التي تحوي تلك الصورة.</div>

ドライブにアップロードされたファイルは、いつでもダウンロードすることができるほか、ノート作成時に「ドライブからファイルを添付」することでファイルを再利用することもできます。

يمكنك إنشاء مجلدات في قرص التخزين لتنظيم ملفاتك.
