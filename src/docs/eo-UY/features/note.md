...
<div class="warn">⚠️ Se oni sendis nur al sekvantoj aŭ rekte, tiuj notoj ne estas plusendeblaj.</div>
...
### Nur al sekvantoj
Viaj notoj aperos nur al viaj sekvantoj.フォロワーの全てのタイムラインに流れます。
