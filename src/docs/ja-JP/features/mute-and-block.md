...
また、より強力な措置として、ブロックを行うことでそのユーザーが自分に対して関わることができないようにすることができます。
...
## ブロック
ユーザーをブロックすると、そのユーザーはあなたに対して以下のようなアクションをすることができなくなります。
...
また、ブロックする際に既にそのユーザーからフォローされていた場合はフォローが解除されます。
