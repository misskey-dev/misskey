...
<div class="cmuxhskf _root" v-hotkey.global="keymap">
	...
	<XTutorial v-if="$store.reactiveState.tutorial.value != -1" class="tutorial _blockIsolated"/>
	<XPostForm v-if="$store.reactiveState.showFixedPostForm.value" class="post-form _blockIsolated" fixed/>
	<div class="tabs _block _isolated _section">
		<div class="left">
