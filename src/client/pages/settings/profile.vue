...
<FormBase>
	...
	<FormSwitch v-model:value="pleromaTimeline">{{ $ts.flagPleroma }}<template #desc>{{ $ts.flagPleromaDescription }}</template></FormSwitch>
...
export default defineComponent({
	...
	created() {
		...
		this.pleromaTimeline = this.$i.pleromaTimeline;
		...
		this.$watch('pleromaTimeline', this.save);
	...
	methods: {
		...
		save() {
			...
			os.apiWithDialog('i/update', {
				...
				isBot: !!this.isBot,
				isCat: !!this.isCat,
				pleromaTimeline: !!this.pleromaTimeline,
