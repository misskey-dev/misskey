...
<div class="xqnhankfuuilcwvhgsopeqncafzsquya">
	...
	<div class="board">
		<div class="labels-x" v-if="$accountSettings.gamesReversiShowBoardLabels">
			<span v-for="i in game.map[0].length">{{ String.fromCharCode(64 + i) }}</span>
		</div>
		<div class="flex">
			<div class="labels-y" v-if="$accountSettings.gamesReversiShowBoardLabels">
			...
			<div class="cells" :style="cellsStyle">
				...
				>
					<template v-if="$accountSettings.gamesReversiUseAvatarStones || true">
