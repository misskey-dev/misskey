...
export const router = new VueRouter({
	...
	routes: [
		...
		{ path: '/lists', component: () => import('./pages/manage-lists/index.vue').then(m => m.default) },
		{ path: '/lists/:list', component: () => import('./pages/manage-lists/list.vue').then(m => m.default) },
