...
<div class="mfcuwfyp">
	...
	<button class="_loadMore" v-appear="$pizzax.state.enableInfiniteScroll ? fetchMore : null" @click="fetchMore" v-show="more" :disabled="moreFetching" :style="{ cursor: moreFetching ? 'wait' : 'pointer' }">
