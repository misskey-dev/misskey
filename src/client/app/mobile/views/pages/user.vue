...
<mk-ui>
	...
	<main v-if="!fetching">
		...
		<div class="is-remote" v-if="user.host != null"><p><fa icon="exclamation-triangle"/> {{ $t('@common.is-remote-user') }}<a :href="user.url || user.uri" target="_blank">{{ $t('@common.view-on-remote') }}</a></p></div>
		<header>
