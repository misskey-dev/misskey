...
<div class="root home">
	...
	<section class="recent-notes">
		<h2><font-awesome-icon icon="R comments"/>%i18n:@recent-notes%</h2>
		<div>
			<x-notes :user="user"/>
		</div>
	</section>
	<section class="images">
		<h2><font-awesome-icon icon="image"/>%i18n:@images%</h2>
		<div>
			<x-photos :user="user"/>
		</div>
	</section>
	<section class="activity">
		<h2><font-awesome-icon icon="chart-bar"/>%i18n:@activity%</h2>
		<div>
			<mk-activity :user="user"/>
		</div>
	</section>
	<section class="frequently-replied-users">
		<h2><font-awesome-icon icon="users"/>%i18n:@frequently-replied-users%</h2>
		<div>
			<x-friends :user="user"/>
		</div>
	</section>
	<section class="followers-you-know" v-if="$store.getters.isSignedIn && $store.state.i.id !== user.id">
		<h2><font-awesome-icon icon="users"/>%i18n:@followers-you-know%</h2>
		<div>
