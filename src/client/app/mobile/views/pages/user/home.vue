...
<div class="root home">
	...
	<section class="images">
		<h2><f-a icon="image"/>%i18n:@images%</h2>
		<div>
			<x-photos :user="user"/>
		</div>
	</section>
	<section class="activity">
		<h2><f-a icon="chart-bar"/>%i18n:@activity%</h2>
		<div>
			<mk-activity :user="user"/>
		</div>
	</section>
	<section class="frequently-replied-users">
		<h2><f-a icon="users"/>%i18n:@frequently-replied-users%</h2>
		<div>
			<x-friends :user="user"/>
		</div>
	</section>
	<section class="followers-you-know" v-if="$store.getters.isSignedIn && $store.state.i.id !== user.id">
		<h2><f-a icon="users"/>%i18n:@followers-you-know%</h2>
		<div>
