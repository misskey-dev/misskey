			...
			<div class="body" v-if="appearNote.deletedAt == null">
				...
				<div class="content" v-show="appearNote.cw == null || showContent">
					<div class="text">
						...
						<misskey-flavored-markdown v-if="appearNote.text" :text="appearNote.text" :author="appearNote.user" :i="$store.state.i" :class="$style.text" :custom-emojis="appearNote.emojis"/>
