		...
		<div class="main">
			...
			<div class="body">
				...
				<div class="content" v-show="appearNote.cw == null || showContent">
					...
					<a class="location" v-if="appearNote.geo" :href="`https://maps.google.com/maps?q=${appearNote.geo.coordinates[1]},${appearNote.geo.coordinates[0]}`" target="_blank"><font-awesome-icon icon="map-marker-alt"/> 位置情報</a>
