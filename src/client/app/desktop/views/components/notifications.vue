			...
			<template v-for="(notification, i) in _notifications">
				<div class="notification" :class="notification.type" :key="notification.id">
					...
					<template v-if="notification.type == 'renote'">
						...
						<div class="text">
							<p><font-awesome-icon icon="retweet"/>
					...
					<template v-if="notification.type == 'quote'">
						<mk-avatar class="avatar" :user="notification.note.user"/>
						<div class="text">
							<p><font-awesome-icon icon="quote-left"/>
								<router-link :to="notification.note.user | userPage" v-user-preview="notification.note.userId">{{ notification.note.user | userName }}</router-link>
							</p>
					...
					<template v-if="notification.type == 'follow'">
						<mk-avatar class="avatar" :user="notification.user"/>
						<div class="text">
							<p><font-awesome-icon icon="user-plus"/>
								<router-link :to="notification.user | userPage" v-user-preview="notification.user.id">{{ notification.user | userName }}</router-link>
							</p>
						</div>
					</template>
					...
					<template v-if="notification.type == 'receiveFollowRequest'">
						<mk-avatar class="avatar" :user="notification.user"/>
						<div class="text">
							<p><font-awesome-icon icon="user-clock"/>
								<router-link :to="notification.user | userPage" v-user-preview="notification.user.id">{{ notification.user | userName }}</router-link>
							</p>
						</div>
					</template>
					...
					<template v-if="notification.type == 'reply'">
						<mk-avatar class="avatar" :user="notification.note.user"/>
						<div class="text">
							<p><font-awesome-icon icon="reply"/>
								<router-link :to="notification.note.user | userPage" v-user-preview="notification.note.userId">{{ notification.note.user | userName }}</router-link>
							</p>
							<router-link class="note-preview" :to="notification.note | notePage">{{ getNoteSummary(notification.note) }}</router-link>
						</div>
					...
					<template v-if="notification.type == 'poll_vote'">
						<mk-avatar class="avatar" :user="notification.user"/>
						<div class="text">
							<p><font-awesome-icon icon="chart-pie"/><a :href="notification.user | userPage" v-user-preview="notification.user.id">{{ notification.user | userName }}</a></p>
							<router-link class="note-ref" :to="notification.note | notePage">
								<font-awesome-icon icon="quote-left"/>{{ getNoteSummary(notification.note) }}<font-awesome-icon icon="quote-right"/>
							</router-link>
						</div>
