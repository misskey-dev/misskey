...
<div class="mk-welcome">
	...
	<button @click="dark">
		<template v-if="$store.state.device.darkmode"><font-awesome-icon icon="moon"/></template>
		<template v-else><font-awesome-icon icon="R moon"/></template>
	</button>
	...
	<main>
		<div class="body">
			...
			<div class="announcements block">
				<header><font-awesome-icon icon="broadcast-tower"/> %i18n:@announcements%</header>
			...
			<div class="photos block">
				<header><font-awesome-icon icon="images"/> %i18n:@photos%</header>
				<div>
			...
			<div class="side">
				...
				<div class="tl block">
					<header><font-awesome-icon icon="comment-alt R"/> %i18n:@timeline%</header>
					<div>
				...
				<div class="info block">
					<header><font-awesome-icon icon="info-circle"/> %i18n:@info%</header>
					<div>
