...
<mk-ui>
	<div class="xygkxeaeontfaokvqmiblezmhvhostak" v-if="!fetching">
		<div class="is-suspended" v-if="user.isSuspended"><font-awesome-icon icon="exclamation-triangle"/> %i18n:@is-suspended%</div>
		<div class="is-remote" v-if="user.host != null"><font-awesome-icon icon="exclamation-triangle"/> %i18n:common.is-remote-user%<a :href="user.url || user.uri" target="_blank">%i18n:common.view-on-remote%</a></div>
		<main>
			<div class="main">
				<x-header :user="user"/>
