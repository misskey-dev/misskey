...
<mk-ui :class="$style.root">
	<div class="qlvquzbjribqcaozciifydkngcwtyzje" ref="body" :style="style" :class="{ center: $store.state.device.deckColumnAlign == 'center' }" v-hotkey.global="keymap">
		...
		<button ref="add" @click="add" title="%i18n:common.deck.add-column%"><font-awesome-icon icon="plus"/></button>
	</div>
</mk-ui>
</template>
	...
	methods: {
		...
		add() {
			this.os.new(Menu, {
				...
				compact: true,
				items: [{
					icon: '<font-awesome-icon icon="home"/>',
					...
					icon: '<font-awesome-icon icon="comments R"/>',
					...
					icon: '<font-awesome-icon icon="share-alt"/>',
					...
					icon: '<font-awesome-icon icon="globe"/>',
					...
					icon: '<font-awesome-icon icon="at"/>',
					...
					icon: '<font-awesome-icon icon="envelope R"/>',
					...
					icon: '<font-awesome-icon icon="bell R"/>',
					...
					icon: '<font-awesome-icon icon="calculator"/>',
