...
<div class="tumhkfkmgtvzljezfvmgkeurkfncshbe">
	<ui-card>
		<div slot="title"><f-a icon="plus"/> %i18n:@add-emoji.title%</div>
	...
	<ui-card>
		<div slot="title"><f-a :icon="['far', 'grin']"/> %i18n:@emojis.title%</div>
		<section v-for="emoji in emojis">
			...
			<ui-horizon-group>
				<ui-button @click="updateEmoji(emoji)"><f-a :icon="['far', 'save']"/> %i18n:@emojis.update%</ui-button>
				<ui-button @click="removeEmoji(emoji)"><f-a :icon="['far', 'trash-alt']"/> %i18n:@emojis.remove%</ui-button>
			</ui-horizon-group>
		</section>
	</ui-card>
</div>
