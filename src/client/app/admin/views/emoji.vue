...
<div class="tumhkfkmgtvzljezfvmgkeurkfncshbe">
	...
	<ui-card>
		<div slot="title"><f-a icon="grin R"/> %i18n:@emojis.title%</div>
		<section v-for="emoji in emojis">
			...
			<ui-horizon-group>
				<ui-button @click="updateEmoji(emoji)"><f-a icon="save R"/> %i18n:@emojis.update%</ui-button>
				<ui-button @click="removeEmoji(emoji)"><f-a icon="trash-alt R"/> %i18n:@emojis.remove%</ui-button>
			</ui-horizon-group>
		</section>
	</ui-card>
</div>
