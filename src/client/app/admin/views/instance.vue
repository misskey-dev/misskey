...
<div>
	<ui-card>
		...
		<section>
			...
			<ui-switch v-model="disableCustomReaction">{{ $t('disable-custom-reaction') }}</ui-switch>
		</section>
		<section class="fit-bottom">
...
export default Vue.extend({
	...
	created() {
		this.$root.getMeta().then(meta => {
			...
			this.disableCustomReaction = meta.disableCustomReaction;
	...
	methods: {
		...
		updateMeta() {
			this.$root.api('admin/update-meta', {
				...
				disableCustomReaction: this.disableCustomReaction,
