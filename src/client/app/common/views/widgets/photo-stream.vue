...
<div class="mkw-photo-stream" :class="$style.root" :data-melt="props.design == 2">
	<mk-widget-container :show-header="props.design == 0" :naked="props.design == 2">
		<template slot="header"><font-awesome-icon icon="camera"/>%i18n:@title%</template>

		<p :class="$style.fetching" v-if="fetching"><font-awesome-icon icon="spinner .pulse .fw"/>%i18n:common.loading%<mk-ellipsis/></p>
