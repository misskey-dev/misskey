<template>
<ui-card>
	<div slot="title"><font-awesome-icon icon="key"/> API</div>
	...
	<section class="fit-top">
		...
		<ui-button @click="regenerateToken"><font-awesome-icon icon="sync-alt"/> %i18n:@regenerate-token%</ui-button>
	</section>

	<section>
		<header><font-awesome-icon icon="terminal"/> %i18n:@console.title%</header>
		...
		<ui-button @click="send" :disabled="sending">
			...
			<template v-else><font-awesome-icon icon="paper-plane"/> %i18n:@console.send%</template>
		</ui-button>
