<template>
<ui-card>
	<div slot="title"><f-a icon="key"/> API</div>
	...
	<section class="fit-top">
		...
		<ui-button @click="regenerateToken"><f-a icon="sync-alt"/> %i18n:@regenerate-token%</ui-button>
	</section>

	<section>
		<header><f-a icon="terminal"/> %i18n:@console.title%</header>
		...
		<ui-button @click="send" :disabled="sending">
			...
			<template v-else><f-a icon="paper-plane"/> %i18n:@console.send%</template>
		</ui-button>
