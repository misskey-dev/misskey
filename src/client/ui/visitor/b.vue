	...
	<div class="main">
		...
		<div class="contents">
			...
			<div class="powered-by" v-if="!root">
				<b><MkA to="/">{{ host }}</MkA></b>
				<small>Powered by <a href="https://github.com/tamaina/misskey" target="_blank">Misskey</a></small>
			</div>
		</div>
	</div>
