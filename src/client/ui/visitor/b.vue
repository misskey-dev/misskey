	...
	<div class="main">
		...
		<div class="contents">
			...
			<div class="powered-by" v-if="!root">
				<b><MkA to="/">{{ host }}</MkA></b>
				<small>由 <a href="https://github.com/nyaone/misskey" target="_blank">Misskey</a> 强力驱动喵</small>
			</div>
		</div>
	</div>
